...
<html>
    ...
    <body>
        ...
        <div id="show-gameStats" class="content scaffold-show" role="main">
            ...
            <f:display bean="gameStats" />
            <g:form resource="${this.gameStats}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.gameStats}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
